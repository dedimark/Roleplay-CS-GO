...
public void LoadAppartementsSQL(int client) 
{
	...
	rp_GetDatabase().Query(LoadCallBackSQL, buffer, GetClientUserId(client));
}
...
public Action RP_OnPlayerInteract(int client, int target, const char[] class, const char[] model, const char[] name)
{
	...
	if(StrEqual(entityName, "Agent Immobilier"))
	{
		int nbImmo;
		LoopClients(i)
		{
		...
		{
			PrintHintText(client, "Malheureusement je suis indisponible, contactez un agent immoblier.");
			CPrintToChat(client, "Malheureusement je suis indisponible, contactez un agent immoblier.");
		}	
	}	
}
...
Menu SellAppartement(int client, int target)
{
	LoopClients(i)
	{
		...
		if(rp_GetClientInt(target, i_appartement) == 0)
		{
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_18");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_17");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_15");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_16");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_31");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_32");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_33");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_34");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_35");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_41");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_42");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_43");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_44");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_13");
			...
			{				
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_14");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_11");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_12");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_38");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_37");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_36");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_46");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_45");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_48");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_47");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_21");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_22");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_24");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_23");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_27");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_28");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_25");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_26");
			...
			{
				prix = rp_GetAppartementPrice(rp_GetDatabase(), "appart_0301");
		...
		if(!StrEqual(buffer[4], "non"))
		{
			...
			if(StrContains(buffer[2], "appart_") != -1)
			{
				if(StrEqual(buffer[2], "appart_0301"))
				{
					...
					SetSQL_Int(rp_GetDatabase(), "rp_immobilier", "appartement", rp_GetClientInt(client, i_appartement), steamID[client]);
					
					rp_SetClientKeyAppartement(client, StringToInt(strAppart[1]), true);
					rp_SetClientInt(client, i_AppartCount, rp_GetClientInt(client, i_AppartCount) + 1);
					
					UpdateSQL(rp_GetDatabase(), "UPDATE rp_appartements SET proprietaire = '%s' WHERE appartement = '%s';", steamID[client], buffer[2]);
					UpdateSQL(rp_GetDatabase(), "UPDATE rp_appartements SET loyer = 604800 WHERE appartement = '%s';", buffer[2]);
			...
			{			
				...
				{
					rp_ClientGiveItem(client, immo_propfaim, rp_GetClientItem(client, immo_propfaim) + quantity);	
					SetSQL_Int(rp_GetDatabase(), "rp_dealer", buffer[2], rp_GetClientItem(client, immo_propfaim), steamID[client]);
				}
				else if(StrEqual(buffer[2], "prop_atm"))
				{
					rp_ClientGiveItem(client, immo_propatm, rp_GetClientItem(client, immo_propatm) + quantity);	
					SetSQL_Int(rp_GetDatabase(), "rp_immobilier", buffer[2], rp_GetClientItem(client, immo_propatm), steamID[client]);
				} 
			}	
		}
